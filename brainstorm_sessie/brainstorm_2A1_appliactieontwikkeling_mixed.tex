...
Dieter: De thesis \cite(CosmanAlexander2011) over streaming beschikbaar maken in een goed formaat leek mij een zeer interessant. Dit omdat een streaming app voor een smartphone een leuk projectje lijkt aangezien dat de concurentie in die categorie nog redelijk klein is.
...
\bibliography{thomasbiblio}
\bibliography{Dieterbiblio}
